...
public class AccountDTO {
    ...
    public AccountDTO(String id, String username, String password, String email, String phone ,int role) {
        this.id = id;
        this.username = username;
        this.password = password;
        this.email = email;
    ...
    public String toString() {
        return "AccountDTO{" + "id=" + id + ", username=" + username + ", password=" + password + ", email=" + email + ", phone=" + phone + ", isAdmin=" + role + '}';
    }
